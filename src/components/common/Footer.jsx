  ...
  return (
    <footer className="relative overflow-hidden bg-gradient-to-br from-gray-950 via-slate-950 to-blue-950 text-white">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 left-0 w-[420px] h-[420px] bg-blue-500/10 blur-3xl rounded-full animate-[footerMove1_28s_linear_infinite]"></div>
        <div className="absolute bottom-0 right-0 w-[420px] h-[420px] bg-sky-400/10 blur-3xl rounded-full animate-[footerMove2_34s_linear_infinite]"></div>
      </div>
      ...
      <div className="container-custom relative z-10">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div>
              ...
              <p className="mt-5 text-gray-300 leading-relaxed max-w-2xl">
                Join Codebaby Software for courses, placements, internships,
                projects and modern software solutions.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 lg:justify-end">
              ...
              <Link
                to="/courses"
                className="px-6 py-3 bg-blue-600 rounded-xl font-semibold hover:bg-blue-700 transition flex items-center justify-center gap-2"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="px-6 py-3 border border-white/20 rounded-xl font-semibold hover:bg-white/10 transition flex items-center justify-center gap-2"
              >
                WhatsApp <FaWhatsapp />
              </a>
        ...
        <div className="py-16 grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="mt-5 text-gray-300 leading-relaxed">
              Premium IT training company helping students and professionals
              through skill development, placements and real-world solutions.
            </p>
          ...
          <div>
            ...
            <ul className="mt-6 space-y-3 text-gray-300">
              ...
              <li>
                <Link to="/placements" className="hover:text-white transition">
                  Placements
                </Link>
              </li>
        ...
        {/* BOTTOM */}
        <div className="py-6 border-t border-white/10 flex flex-col md:flex-row gap-4 items-center justify-between text-sm text-gray-400">
