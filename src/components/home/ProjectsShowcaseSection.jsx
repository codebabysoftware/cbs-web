...
const ProjectsShowcaseSection = () => {
  ...
  const getIcon = (type = "") => {
    ...
    if (value.includes("academic")) return FaGraduationCap;
    if (value.includes("mini")) return FaLaptopCode;
    return FaCode;
  };
  ...
  return (
    <section className="relative overflow-hidden py-16 md:py-24 bg-gradient-to-br from-white via-blue-50 to-white">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-[420px] h-[420px] bg-blue-200/20 blur-3xl rounded-full animate-[projectMove1_28s_linear_infinite]"></div>

        <div className="absolute bottom-0 right-0 w-[420px] h-[420px] bg-sky-200/20 blur-3xl rounded-full animate-[projectMove2_34s_linear_infinite]"></div>

        <div className="absolute top-1/2 left-1/3 w-[320px] h-[320px] bg-cyan-200/15 blur-3xl rounded-full animate-[projectMove3_38s_linear_infinite]"></div>
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-3 text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
            Projects That Build
            <span className="text-blue-600"> Skills & Results</span>
          </h2>

          <p className="mt-5 text-gray-600 text-base md:text-lg leading-relaxed">
            From student academic submissions to real business applications —
            we build practical projects with modern technologies.
          </p>
        ...
        <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {filteredProjects.map((project, index) => {
            const Icon = getIcon(project.type || project.category || "");
